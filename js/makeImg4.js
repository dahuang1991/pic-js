    ...
    if ($(".opaperImg").length <= 5) {
        if ($(this).index() <= 3) {
            $("#myImg").prepend(
                ...
                "<img src='" + $(this).children("img").attr('src') + "' class='bigpaper'></div>");
        } else if ($(this).index() > 3 && $(this).index() <= 9) {
            $("#myImg").prepend(
                "<div class='opaperImg absol'>" +
                "<div class='real'><img src='img/close.png' class='absol closeImg' ></div>" +
                "<img src='" + $(this).children("img").attr('src') + "' class='mpaper'></div>");
        } else {
            $("#myImg").prepend(
                "<div class='opaperImg absol'>" +
                "<div class='real'><img src='img/close.png' class='absol closeImg' ></div>" +
                "<img src='" + $(this).children("img").attr('src') + "' class='tpaper'></div>");
        }
